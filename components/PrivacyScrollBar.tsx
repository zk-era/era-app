...
const privacySections = [
  { title: "Scope and Updates", id: "scope" },
  { title: "Personal Information We Collect", id: "collection" },
  { title: "How We Use Your Information", id: "usage" },
  { title: "How We Disclose Your Information", id: "disclosure" },
  { title: "Your Privacy Choices and Rights", id: "rights" },
  { title: "International Transfers", id: "international" },
  { title: "Children's Information", id: "children" },
  { title: "Retention", id: "retention" },
  { title: "Nevada Residents", id: "nevada" },
  { title: "European Users", id: "european" },
  { title: "Other Provisions", id: "other" },
  { title: "Contact Us", id: "contact" },
];

export const PrivacyScrollBar = ({
  activeSection,
  setActiveSection,
}: {
    ...
    <div className="fixed bottom-5 right-1/2 z-50 translate-x-1/2 flex-col overflow-hidden rounded-2xl sm:right-5 sm:translate-x-0">
      <AnimatePresence mode="popLayout">
        <motion.div
          ...
          key={activeSection}
        >
          <ScrollCard section={privacySections[activeSection]} />
        </motion.div>
      </AnimatePresence>
